...
const SAFA_VERSE = {
  ...
  tr: "Innaṣ-Ṣafā wal-Marwata min shaʿāʾirillāh. Faman ḥajjal-bayta awiʿtamara falā junāḥa ʿalayhi an yaṭṭawwafa bihimā. Wa man taṭawwaʿa khayran fa-innallāha shākirun ʿalīm. Nabdaʾu bimā badaʾallāhu bih.",
  en: "Indeed, Safa and Marwah are among the symbols of Allah. So whoever makes Ḥajj or ʿUmrah of the House — there is no blame upon him for walking between them. And whoever does good voluntarily, then indeed Allah is Appreciative and Knowing. (We begin with what Allah began with.)",
};
