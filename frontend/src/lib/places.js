...
export const PLACES = [
  ...
  },
  {
    ...
    name_ar: "السبع مساجد",
    subtitle_en: "Khandaq battle line · historical interest only",
    subtitle_ar: "خطّ غزوة الخندق · للاطّلاع التّاريخي فقط",
    description_en:
      "A cluster of small historic mosques on the western edge of Madīnah marking the line of the Khandaq (Trench) battle. Note: the Salafī scholars (Ibn Bāz, Ibn ʿUthaymīn, the Saudi Permanent Committee) have stated there is no Sunnah basis for visiting these specifically as ziyārah — most are later constructions named in honour of the companions, not their personal mosques. Visiting for historical learning is fine; making them objects of worship is not. They were largely consolidated into a single complex in 2017.",
    description_ar:
      "مجموعة مساجد تاريخيّة صغيرة في غرب المدينة عند خطّ غزوة الخندق. تنبيه: أفتى علماء أهل السنّة (ابن باز، ابن عثيمين، اللّجنة الدّائمة) أنّه لا أصل في السنّة لتخصيص زيارتها — وأكثرها بُني متأخّرًا تكريمًا للصّحابة، لا أنّها مساجدهم الخاصّة. زيارتها للاطّلاع التّاريخي جائزة، أمّا تخصيصها بعبادة فلا يجوز. وقد دُمج معظمها في مَجمَع واحد عام ٢٠١٧م.",
    lat: 24.4858,
    lng: 39.5969,
  },
  {
  ...
  },
  {
    ...
    subtitle_en: "Ottoman mosque · Prophet's Eid prayer site",
    subtitle_ar: "مسجد عثماني · مصلّى العيد",
    description_en:
      "An Ottoman-era mosque just south-west of Masjid an-Nabawī, marking the open ground where the Prophet ﷺ used to lead the Eid and rain (Istisqāʾ) prayers — well-attested in the authentic Sunnah. The popular tradition that a cloud (ghamāmah) shaded him here is from weak narrations and is not part of the established Sunnah; the site itself is historically significant on its own.",
    description_ar:
      "مسجد عثماني جنوب غرب المسجد النّبوي، يعلِّم على الأرض المكشوفة الّتي كان يصلّي فيها النبي ﷺ صلاة العيد والاستسقاء — وهذا ثابت في السنّة الصّحيحة. أمّا قصّة الغمامة الّتي أظلّته فهي من الرّوايات الضّعيفة وليست من السنّة الثّابتة، ويكفي الموضع شرفًا أنّه مصلّى رسول الله ﷺ.",
    lat: 24.4677,
    lng: 39.6097,
  },
  {
    ...
    city: "madinah",
    name_en: "Mosques named after Abū Bakr, ʿUmar & ʿAlī",
    name_ar: "مساجد منسوبة إلى أبي بكر وعمر وعليّ",
    subtitle_en: "Honorific mosques near the Prophet's Mosque",
    subtitle_ar: "مساجد تكريميّة بجوار المسجد النّبوي",
    description_en:
      "Three small historic mosques close to Masjid an-Nabawī, named in honour of three of the rightly-guided caliphs. They are not personal mosques of the caliphs themselves — most were built centuries later. The Salafī position is that there is no Sunnah basis for offering specific worship at these sites; visiting is permitted as a matter of historical interest only.",
    description_ar:
      "ثلاثة مساجد تاريخيّة صغيرة قرب المسجد النّبوي، نُسبت إلى ثلاثة من الخلفاء الرّاشدين تكريمًا لهم. وليست مساجدهم الخاصّة، بل بُني أكثرها بعد قرون. ولا أصل في السنّة لتخصيصها بعبادة عند أهل السنّة، وزيارتها جائزة من باب الاطّلاع التّاريخي فقط.",
    lat: 24.4682,
    lng: 39.6094,
  },
  {
